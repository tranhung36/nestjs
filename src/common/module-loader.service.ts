import { Injectable, Inject, Scope, OnModuleInit, forwardRef } from '@nestjs/common';
import {
...
export class ModuleLoaderService implements OnModuleInit {
    constructor(
        @Inject(forwardRef(() => MODULE_LOADER_OPTIONS)) private _options: IModuleLoaderOptions,
        @Inject(forwardRef(() => MODULE_LOADER_NAMES)) private _moduleNames: Array<string>,
